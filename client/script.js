...
sayHelloButton.addEventListener("mouseover", handleMouseOver)
...
sayHelloButton.addEventListener("mouseout", handleMouseOut)
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/berrycrazy').then((res) => {
...
// CODE HERE
function queryTest() {
    axios.get('http://localhost:3000/query-test', { params: { first: 'primeiro', second: 'segundo' } }).then((res) => {
        console.log(res.data)
    })
}
